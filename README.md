...
Then, clone MPZRPC with `git clone https://github.com/FlYwithcoder/mpzRPCFrame.git`.
...
# 💻 Usage
 ...
 Run RPC provider with `/path/to/MPZRPC/bin/provider -i test.conf`.
 
 Run RPC consumer with `/path/to/MPZRPC/bin/consumer -i test.conf`.
